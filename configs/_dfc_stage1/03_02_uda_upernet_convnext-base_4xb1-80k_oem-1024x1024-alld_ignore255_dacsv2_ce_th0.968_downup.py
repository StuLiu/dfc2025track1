...
_base_ = [
    ...
    '../_base_/uda/uda_upernet_convnextv2-base_dacs.py',
...
model = dict(
    ...
    segmentor=dict(
        ...
        train_cfg=dict(
            work_dir='work_dirs/03_02_uda_upernet_convnext-base_4xb1-80k_oem-1024x1024-alld_ignore255_dacsv2_ce_th0.968_downup'
        ),
