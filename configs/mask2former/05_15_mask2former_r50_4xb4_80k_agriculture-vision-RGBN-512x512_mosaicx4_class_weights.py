_base_ = ['../_base_/default_runtime.py', '../_base_/datasets/agriculture_vision.py']
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_cls=dict(
            ...
            use_sigmoid=False,
            loss_weight=2.0,
            class_weight=[0.5, 2.0, 1.0, 2.0, 1.0, 2.0, 2.0, 2.0, 1.0] + [0.1]),
        loss_mask=dict(
            type='mmdet.CrossEntropyLoss',
            use_sigmoid=True,
            reduction='mean',
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=80000, val_interval=20000)
