...
_base_ = [
    ...
    '../_base_/datasets/uda_oem2oem_768x768_saugs_downup.py',
...
model = dict(
    ...
    segmentor=dict(
        ...
        train_cfg=dict(
            work_dir='work_dirs/02_26_uda_segformer_mit-b3_2xb4-80k_oem-768x768-alld_ignore255_dacsv2_ce_th0.968_downup'
        ),
