...
data_root = 'data/2024-CVPR-Agriculture-Vision/supervised/Agriculture-Vision-2021-MMSeg-RGBNM-MultiLabel'
train_pipeline = [
    dict(type='LoadTifImageFromFileV3'),
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(type='MultiLabelACWLoss')))
