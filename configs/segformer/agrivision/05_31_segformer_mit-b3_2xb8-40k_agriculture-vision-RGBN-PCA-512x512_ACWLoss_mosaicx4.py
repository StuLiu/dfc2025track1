...
data_preprocessor = dict(
    mean=[111.46, 113.90, 112.23, 118.30, 144.00, 144.00, 144.00],
    std=[43.75, 41.29, 41.72, 46.56, 46.80, 46.80, 46.80],
    bgr_to_rgb=False,
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='img_dir/train_val_mosaic-RGBN-PCA',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=test_pipeline,
        data_prefix=dict(
            img_path='img_dir/test-RGBN-PCA',
